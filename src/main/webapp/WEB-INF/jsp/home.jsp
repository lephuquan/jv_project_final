<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %> <!-- change -->
<!DOCTYPE html>
<html>
<head>
		<meta charset="utf-8">
		...
		<!-- Google font -->
		<link href="<c:url value="resources/https://fonts.googleapis.com/css?family=Montserrat:400,500,700"/>" rel="stylesheet"><!--chu y  -->
		<!-- Bootstrap -->
